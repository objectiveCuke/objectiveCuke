...
//		[self injectjQuery];
	...
	[(UIWebView*)self stringByEvaluatingJavaScriptFromString:javascript];
...
-(void) injectjQuery {
	...
	[(UIWebView*)self stringByEvaluatingJavaScriptFromString: jQueryInjection];	
}
...
-(NSString *) html {
	return [(UIWebView*)self stringByEvaluatingJavaScriptFromString: @"document.body.innerHTML"];
}
